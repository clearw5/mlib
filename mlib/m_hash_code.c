...
#ifndef MLIB_M_HASH_CODE_C_
#define MLIB_M_HASH_CODE_C_
...
static int crc_table[256] = { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba,
...
m_hash m_hash_code_crc32(m_pointer data, size_t size) {
	m_hash hash = 0xffffffff;
	char *val = (char*) data;
	for (index_t i = 0; i < size; i++) {
		hash = crc_table[(hash ^ *(val++)) & 0xff] ^ (hash >> 8);
	}
	return hash ^ 0xffffffff;
}

#endif /* MLIB_M_HASH_CODE_C_ */
